...
\caption{Top: The relative discovery significance (true positive rate / square root of false positive rate) as a function of the classifier threshold for HL observables and LL observables before and after the FGSM attack described in Sec.~\ref{subsec:fgsm}.  }
\label{fig:FGSM2}
\end{figure}
